  ...
  return (
    <div id="home" className="bg-blue-500">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center max-w-6xl mx-auto py-10">
        <div className="lg:col-start-1 lg:pl-5 justify-self-center space-y-3 px-5">
          ...
          <p className="md:text-lg mb-5 max-w-lg text-center lg:text-left text-pretty md:text-wrap lg:text-balance ">
          ...
          <Button
            ...
            className="relative left-1/2 -translate-x-1/2  lg:left-0 lg:translate-x-0 w-fit"
          >
            Get Started
          </Button>
        </div>
        <div className="lg:col-start-2 w-full justify-self-start px-5 lg:px-0 lg:pr-10">
          <Image
